...
/**
 * get_op_func - function searches for a match between opcode
 * and text and returns the corresponding function
 * @line: struct containing contents and line number
